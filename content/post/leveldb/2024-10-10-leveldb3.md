...
author:       "Sutdown"
description:  "leveldb filesysytem 源码阅读，包括文件系统的实现、文件的读写操作、文件的压缩等。"
date:         2024-10-10
toc: true
categories:
    - levelDB
...
> ![hash table](/static/img/images/11.jpg)
>
...
![9](/static/img/images/9.jpg)

sstable中各类block的保存数据，仅关注key/value.

![10](/static/img/images/10.jpg)
