...
![38](/static/img/images_stl/38.jpg)

#### Chapter 2 IP协议

![39](/static/img/images_stl/39.jpg)

#### Chapter 3 TCP协议

![40](/static/img/images_stl/40.jpg)

![41](/static/img/images_stl/41.jpg)	
...
- Reactor模式：主线程只负责监听文件描述符上是否有事件发生，有的话通知工作线程，工作线程中会完成读写数据，接受新连接以及处理客户请求。同步IO
  ...
  ![43](/static/img/images_stl/43.jpg)

- Proactor模式：所有IO都交给主线程和内核处理，工作线程只负责业务逻辑。异步IO

  ![44](/static/img/images_stl/44.jpg)

> Reactor和Proactor模式的区别。

本项目采用**同步IO模拟的Proactor事件处理模式**。

<img src="/img/images_stl/47.jpg" alt="47" style="zoom:67%;" />
...
![46](/static/img/images_stl/46.jpg)
...
![48](/static/img/images_stl/48.jpg)
...
![52](/static/img/images_stl/52.jpg)
...
![49](/static/img/images_stl/49.jpg)
...
![50](/static/img/images_stl/50-1726975754204-5.jpg)
...
![51](/static/img/images_stl/51.jpg)
...
>
> ![53](/static/img/images_stl/53.jpg)
...
2. 建立**请求报文**的有限状态机。请求报文中一般包含post和get。该有限状态机的作用原理在于每次读取缓冲区中的一行进行匹配，直至状态变成finish
   ...
   ![55](/static/img/images_stl/55.jpg)
...
![56](/static/img/images_stl/56.jpg)
...
![57](/static/img/images_stl/57.jpg)
...
![58](/static/img/images_stl/58.jpg)

再来张图，介绍一下所有函数的逻辑

果然比起打字更喜欢直接写出来）

![59](/static/img/images_stl/59.jpg)
